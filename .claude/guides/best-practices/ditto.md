...
- [API Version Awareness (CRITICAL)](#api-version-awareness-critical)
- [Migration Strategies](#migration-strategies)
  - [Upgrading from Legacy API to DQL (SDK 4.12+)](#upgrading-from-legacy-api-to-dql-sdk-412)
  - [Legacy API to DQL Quick Reference](#legacy-api-to-dql-quick-reference)
  - [Upgrading to COUNTER Type (SDK 4.14.0+)](#upgrading-to-counter-type-sdk-4140)
  - [Counter Anti-Patterns and Alternatives](#counter-anti-patterns-and-alternatives)
  - [DQL Subscription Forward-Compatibility (SDK 4.5+)](#dql-subscription-forward-compatibility-sdk-45)
  - [SDK Version Upgrade Checklist](#sdk-version-upgrade-checklist)
- [Ditto Query Language (DQL)](#ditto-query-language-dql)
  - [Overview](#overview)
  - [Query Best Practices](#query-best-practices)
  - [Query Result Handling](#query-result-handling)
  - [Diffing Query Results](#diffing-query-results)
- [SELECT Statements](#select-statements)
  - [Basic Syntax](#basic-syntax)
  - [Projections (Field Selection)](#projections-field-selection)
...
- [DQL Operator Expressions](#dql-operator-expressions)
  - [Date and Time Operators (SDK 4.11+)](#date-and-time-operators-sdk-411)
  - [Conditional Operators](#conditional-operators)
  - [Type Checking Operators](#type-checking-operators)
  - [String Operators](#string-operators)
  - [Object Operators (SDK 4.x+)](#object-operators-sdk-4x)
  - [Collection Operators](#collection-operators)
  - [Operator Performance Considerations](#operator-performance-considerations)
- [Document Model and Data Types](#document-model-and-data-types)
  - [Supported Data Types](#supported-data-types)
  - [⚠️ CRITICAL: Array Limitations](#️-critical-array-limitations)
  - [Document Structure Best Practices](#document-structure-best-practices)
  - [Exclude Unnecessary Fields from Documents](#exclude-unnecessary-fields-from-documents)
  - [DQL Strict Mode (v4.11+)](#dql-strict-mode-v411)
- [ID Generation Strategies for Distributed Systems](#id-generation-strategies-for-distributed-systems)
  - [⚠️ CRITICAL: Avoid Sequential IDs in Distributed Databases](#️-critical-avoid-sequential-ids-in-distributed-databases)
  ...
  - [Document Size and Performance Guidelines](#document-size-and-performance-guidelines)
...
- [Collection Design Patterns](#collection-design-patterns)
  ...
  - [DO UPDATE_LOCAL_DIFF for Efficient Upserts (SDK 4.12+)](#do-update_local_diff-for-efficient-upserts-sdk-412)
  - [INITIAL Documents for Default Data](#initial-documents-for-default-data)
  - [Counter Patterns (PN_INCREMENT and COUNTER Type)](#counter-patterns-pn_increment-and-counter-type)
  - [COUNTER Type Use Cases (Ditto 4.14.0+)](#counter-type-use-cases-ditto-4140)
  - [Event History and Audit Logs](#event-history-and-audit-logs)
  - [Two-Collection Pattern for Real-Time + Historical Data](#two-collection-pattern-for-real-time--historical-data)
- [Subscription Patterns](#subscription-patterns)
  - [How Ditto Syncs Data](#how-ditto-syncs-data)
  - [Understanding Subscriptions and Queries](#understanding-subscriptions-and-queries)
  - [Observe for Real-Time Updates](#observe-for-real-time-updates)
  - [Observer Methods](#observer-methods)
  - [Observer Lifecycle Management](#observer-lifecycle-management)
  - [Replacing Legacy observeLocal with Store Observers (SDK 4.12+)](#replacing-legacy-observelocal-with-store-observers-sdk-412)
  - [Partial UI Updates (Avoid Full Screen Refreshes)](#partial-ui-updates-avoid-full-screen-refreshes)
- [Testing Strategies](#testing-strategies)
  - [Test Business Logic Under Concurrent Scenarios](#test-business-logic-under-concurrent-scenarios)
  - [Test Deletion Scenarios](#test-deletion-scenarios)
- [Performance Best Practices](#performance-best-practices-1)
  - [Optimize Query Scope](#optimize-query-scope)
  - [Subscription Scope Balancing: Too Broad vs Too Narrow](#subscription-scope-balancing-too-broad-vs-too-narrow)
  - [Handle Attachments Explicitly](#handle-attachments-explicitly)
  - [Attachment Architecture](#attachment-architecture)
  - [Best Practices](#best-practices)
  - [Attachment Immutability and Updates](#attachment-immutability-and-updates)
  - [Garbage Collection](#garbage-collection)
  - [The Thumbnail Pattern for Photos and Large Files](#the-thumbnail-pattern-for-photos-and-large-files)
  - [Attachment Availability Constraints](#attachment-availability-constraints)
  - [Attachment Fetch Timeout Handling](#attachment-fetch-timeout-handling)
  - [Transactions](#transactions)
- [Device Storage Management](#device-storage-management)
  - [Understanding EVICT vs DELETE](#understanding-evict-vs-delete)
  - [EVICT Best Practices](#evict-best-practices)
  - [Time-to-Live (TTL) Eviction Strategy](#time-to-live-ttl-eviction-strategy)
  - [Flag-Based Eviction Pattern](#flag-based-eviction-pattern)
  - [Storage Management Patterns](#storage-management-patterns)
  - [Subscription Lifecycle Management](#subscription-lifecycle-management)
  - [Performance Impact](#performance-impact)
- [Timestamp Best Practices](#timestamp-best-practices)
  - [The Timestamp Challenge in Distributed Systems](#the-timestamp-challenge-in-distributed-systems)
  - [Clock Drift Reality](#clock-drift-reality)
...
- [Query Optimization & Indexing](#query-optimization--indexing)
  - [DQL Indexes (SDK 4.12.0+)](#dql-indexes-sdk-4120)
  - [Creating and Managing Indexes](#creating-and-managing-indexes)
  - [Performance Impact and Query Selectivity](#performance-impact-and-query-selectivity)
  - [Advanced Index Usage (SDK 4.13.0+)](#advanced-index-usage-sdk-4130)
  - [Query Plan Analysis with EXPLAIN](#query-plan-analysis-with-explain)
  - [Index Limitations and Considerations](#index-limitations-and-considerations)
  - [Index Usage Best Practices](#index-usage-best-practices)
- [Logging & Observability](#logging--observability)
  - [Log Levels](#log-levels)
  - [Configuring Log Levels](#configuring-log-levels)
  - [Rotating File Logs](#rotating-file-logs)
  - [Logging Best Practices](#logging-best-practices)
  - [System Information Query](#system-information-query)
